...
export default function ZoneUpdateForm(props) {
  ...
  const [zoneRecord, setZoneRecord] = React.useState(zone);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp ? await DataStore.query(Zone, idProp) : zone;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Zone.copyOf(zoneRecord, (updated) => {
